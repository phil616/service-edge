      ...
      <Col xs={24} lg={14}>
        ...
        >
          ...
          <Descriptions column={1} bordered size="small">
            ...
            <Descriptions.Item label="目标 / 已应用配置">{data?.config_version} / {data?.runtime?.applied_config_version || (data?.runtime?.last_apply_error ? '未应用（失败）' : '等待首次应用')}</Descriptions.Item>
